...
public final class XmlMenuLoader {
    ...
    public List<XmlMenuItem> load(Context context) {
        List<XmlMenuItem> items = parseXml(context, R.menu.main);
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                ...
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    if (elemName.equals("item")) {
                        ...
                        String id = xpp.getAttributeValue("http://schemas.android.com/apk/res/android", "id");
                        String iconId = xpp.getAttributeValue("http://schemas.android.com/apk/res/android", "icon");
                        String titleId = xpp.getAttributeValue("http://schemas.android.com/apk/res/android", "title");

                        int resId = Integer.valueOf(id.replace("@", ""));
                        int iconResId = Integer.valueOf(iconId.replace("@", ""));
                        int titleResId = Integer.valueOf(titleId.replace("@", ""));

                        XmlMenuItem item = new XmlMenuItem(resId, iconResId, titleResId);
