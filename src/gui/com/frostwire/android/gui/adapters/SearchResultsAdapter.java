...
import com.frostwire.android.gui.views.AbstractListAdapter2;
 ...
 *
 */
public class SearchResultsAdapter extends AbstractListAdapter2<SearchResult> {
    ...
    protected void populateTorrentPart(View view, TorrentSearchResult sr) {
        TextView seeds = findView(view, R.id.view_bittorrent_search_result_list_item_text_seeds);
        if (sr.getSeeds() > 0) {
            seeds.setText(view.getContext().getResources().getQuantityString(R.plurals.count_seeds_source, sr.getSeeds(), sr.getSeeds()));
        } else {
            seeds.setText("");
        }
    }
